...
public class SendAliMessage {
    ...
    //替换成你的AK
    final static  String accessKeyId = "LTAIGYAW32319eLV";//你的accessKeyId,参考本文档步骤2
    final static String accessKeySecret = "z11qIQu9sZPAq6jioF7lgWuUNMR3C4";//你的accessKeySecret，参考本文档步骤2

    private static SendAliMessage sendAliMessage = new SendAliMessage();
    private SendAliMessage(){}

    private static SendSmsRequest sendSmsRequest;

    public static SendAliMessage before(String password) throws Exception{
        //设置超时时间-可自行调整
